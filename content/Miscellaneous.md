...
- discontent (n)
- uncontrollable
- neu nguyen am ma khong nhan trong am, da phan doc la o
- attempt to
- proposal  (n): ~ suggestion
- strike (v):
- strike (n)
	- put on a strike
- runner
...
- overhear ~ eavesdrop ~ snoop around
	- snitch
- catch on to sth
- **THe fact that phones and apps aren’t good or bad regarding adolescents** can aggravate the difficulties of growing up.
- aggravate (v)
- S + hardly + V(p2) , would 
- Hardly + had/has/have
