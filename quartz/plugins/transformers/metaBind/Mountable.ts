/**
 * Base class for components that can be mounted to the DOM
 * This closely follows the original Meta Bind implementation
 */
export abstract class Mountable {
   ...
   * Will log a warning if the mountable is already mounted.
   */
